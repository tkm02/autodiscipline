...
const Dashboard = ({ theme }) => {
  ...
  const obtenirIconeCategorie = (categorie) => {
    switch (categorie) {
      case "spirituel":
        return <FontAwesomeIcon icon={faMosque} className="icone-categorie spirituel" />
      case "professionnel":
      ...
      {afficherFormulaire && (
        <div className="formulaire-objectif">
          ...
          <div className="grille-formulaire">
            ...
            <div className="groupe-formulaire">
              ...
              <select
                ...
                onChange={(e) => setNouvelObjectif({ ...nouvelObjectif, categorie: e.target.value })}
              >
            ...
            <div className="groupe-formulaire">
              ...
              <select
                ...
                onChange={(e) => setNouvelObjectif({ ...nouvelObjectif, typeDeTracking: e.target.value })}
              >
            ...
            <div className="groupe-formulaire">
              ...
              <select
                value={nouvelObjectif.frequence}
                onChange={(e) => setNouvelObjectif({ ...nouvelObjectif, frequence: e.target.value })}
              >
            ...
            <div className="groupe-formulaire">
              ...
              <input
                ...
                onChange={(e) => setNouvelObjectif({ ...nouvelObjectif, cible: e.target.value })}
              />
          ...
          <div className="actions-formulaire">
            <button className="bouton-annuler" onClick={() => setAfficherFormulaire(false)}>
              Annuler
            </button>
            <button className="bouton-ajouter" onClick={ajouterObjectif}>
              Ajouter l'objectif
            </button>
          </div>
        </div>
          ...
          <table className="tableau-objectifs">
            ...
            <tbody>
              {objectifsFiltres.length === 0 ? (
                <tr>
                  <td colSpan={categorieActive === "tous" ? 6 : 5} className="aucun-objectif">
